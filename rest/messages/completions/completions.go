// Package completions provides requests and responses for the completions API.
package completions
...
// Req is used to create a completion for the provided prompts, parameters and chosen model.
type Req struct {
...
func (r Req) Defaults() Req {
	...
	if r.Stop == nil {
		r.Stop = []string{`<|endoftext|>`}
	}
	return r
}

func (r Req) validate() error {
	if len(r.Prompt) > 2048 {
